...
@Component({
  ...
  styles: [`
    ...
    .sms-badge { display:inline-flex;align-items:center;gap:4px;padding:2px 8px;border-radius:20px;font-size:.68rem;font-weight:500;background:var(--g100);color:var(--g400); }
  `],
  template: `
<div class="page fade-in">
  ...
  <div class="ph">
    ...
    <div class="ph-actions">
      <a class="btn btn-secondary" routerLink="/documentos" style="margin-right:8px">
  ...
  <div class="g2" style="gap:18px">
    ...
    <div style="display:flex;flex-direction:column;gap:14px">
      ...
      <!-- Doctores -->
      <div class="card">
        <h3 style="font-size:.95rem;font-weight:600;margin-bottom:14px">Odontólogos</h3>
        @for (m of medicos; track m.id) {
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1">
              ...
              <div class="xs muted">{{ m.especialidad || 'Odontología general' }}</div>
            </div>
          </div>
        }
        @if (medicos.length === 0) {
          <div class="sm muted" style="padding:10px 0">Sin odontólogos registrados</div>
        }
      </div>

      <!-- Accesos rápidos -->
      <div class="card">
        <h3 style="font-size:.95rem;font-weight:600;margin-bottom:14px">Accesos rápidos</h3>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          <a routerLink="/pacientes" class="qa" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid var(--border);border-radius:var(--r);text-decoration:none;transition:all .15s">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="1.75"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
            <span class="xs" style="color:var(--g600);font-weight:500">Pacientes</span>
          </a>
          <a routerLink="/reportes" class="qa" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid var(--border);border-radius:var(--r);text-decoration:none;transition:all .15s">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="1.75"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
            <span class="xs" style="color:var(--g600);font-weight:500">Reportes</span>
          </a>
          <a routerLink="/documentos" class="qa" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid var(--border);border-radius:var(--r);text-decoration:none;transition:all .15s">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="1.75"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            <span class="xs" style="color:var(--g600);font-weight:500">Documentos</span>
          </a>
          <a routerLink="/citas" class="qa" style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid var(--border);border-radius:var(--r);text-decoration:none;transition:all .15s">
      ...
      <!-- Banner SMS/WhatsApp deshabilitado -->
      <div class="card" style="background:var(--g50);border-style:dashed">
        <div style="display:flex;align-items:center;gap:10px">
          <div style="width:36px;height:36px;border-radius:8px;background:var(--g200);display:flex;align-items:center;justify-content:center;flex-shrink:0">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--g400)" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
          </div>
          <div style="flex:1">
            <div style="font-size:.82rem;font-weight:600;color:var(--g600)">Recordatorios SMS & WhatsApp</div>
            <div style="font-size:.72rem;color:var(--g400)">Automatiza el envío de recordatorios a tus pacientes. Contrata este paquete para activarlo.</div>
          </div>
          <span class="sms-badge">No contratado</span>
        </div>
      </div>
